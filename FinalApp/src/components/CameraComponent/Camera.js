...
export default class CameraScreen extends React.Component {
  ...
  takePicture = async function() {
    ...
    if (this.camera) {
      console.log("if this.camera=true")
  ...
  render() {
    ...
    const camera = this.state.showGallery ? this.renderGallery() : cameraScreenContent;
    return (
      ...
      <Header>
        ...
        <Right>
          <Button transparent onPress={() => this.props.navigation.navigate("CameraDetails")}>
            <Text>Next </Text>
            <Icon name="ios-arrow-forward" />            
          </Button>
        </Right>
      </Header>
      <View style={styles.container}>{camera}</View>
      </Container>
      )
  }
}
